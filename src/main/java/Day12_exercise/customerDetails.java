...
public class customerDetails {
    public static void main(String[] args) {
        ...
        //we are using parameterized constructor to ease to set the customer details. reduces lines of code
        //Customer 1
        ...
        HyndaicustomerInfo CustInfo1= new HyndaicustomerInfo("Aishwarya","Tamil Nadu","Chennai","i10",phoneNumbers);
        ...
        HyndaicustomerInfo CustInfo2= new HyndaicustomerInfo("Ramesh","Kerala","Kochin","i20",phoneNumbers);
        ...
        //Customer 3
        HyndaicustomerInfo CustInfo3= new HyndaicustomerInfo("Ghukhan","Karnataka","Bangalore","Creda",phoneNumbers);
        ...
        Map<String, HyndaicustomerInfo> Customermap= new HashMap<String, HyndaicustomerInfo>();
