...
public class LearnTagname {
    public static void main(String[] args) {
        ...
        //Launch the browser and bing search engine-- with tagname
        ...
        driver.findElement(By.tagName("input")).sendKeys("Seleinum"); // finds the search bar pass "selenium as value
